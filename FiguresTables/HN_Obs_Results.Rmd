...
results_wd = paste(c(strsplit(x = getwd(), split = "/")[[1]][1:(length(strsplit(x = getwd(), split = "/")[[1]])-3)], "ModelResults"), collapse = "/")
...
raw_in = readLines(paste0(results_wd,"/Datasheets/SickKids_origST_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse_20210613_v3.json"))
test = v8()
...
stan_orig_list = make_stan_df(stan_df = stan_df,
             stan_datasheet = read_excel(paste0(results_wd,"/Datasheets/AI Hydronephrosis Data deidentified.xlsx")),
             stan_train = readRDS(paste0(results_wd,"/Datasheets/Stan60%train_ids.rds")))
...
ui_train = readRDS(paste0(results_wd, "/Datasheets/UI60%train_ids.rds"))
...
# Stanford fine-tune model (Table 5)
...
raw_in = readLines(paste0(results_wd, "/Datasheets/SickKids_origST_FineTuneFinalLayersStanford60%_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json"))
test = v8()
test$assign("dat", JS(raw_in))
st_stan_test = test$get("dat")
st_stan_test = add_platt_preds_dprep(in_list = st_stan_test, epoch = 30,sensitivity = SENSITIVITY, verbose=FALSE)
...
raw_in = readLines(paste0(results_wd,"/Datasheets/SickKids_origST_FineTuneFinalLayersUIowa_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json"))
test = v8()
test$assign("dat", JS(raw_in))
st_stan_test = test$get("dat")
...
# Stanford-SickKids train model (Table 6)
## SickKids Silent trial: All visits
```{r, warning=FALSE}
raw_in = readLines(paste0(results_wd,"/Datasheets/Combined_SKST_Inst60%_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json"))
test = v8()
test$assign("dat", JS(raw_in))
st_stan_test = test$get("dat")
...
# UIowa-SickKids train model (Table 6)
## SickKids Silent trial: All visits
```{r, warning=FALSE}
raw_in = readLines(paste0(results_wd,"/Datasheets/Combined_SKUI_Inst60%_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json"))
test = v8()
test$assign("dat", JS(raw_in))
st_stan_test = test$get("dat")
st_stan_test = add_platt_preds_dprep(in_list = st_stan_test, epoch = 20,sensitivity = SENSITIVITY, verbose = FALSE)
...
# Stanford-UIowa-SickKids train model (Table 6)
## SickKids Silent trial: All visits
```{r, warning=FALSE}
raw_in = readLines(paste0(results_wd,"/Datasheets/CombinedInst60%_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json"))
test = v8()
test$assign("dat", JS(raw_in))
st_stan_test = test$get("dat")
st_stan_test = add_platt_preds_dprep(in_list = st_stan_test, epoch = 20,sensitivity = SENSITIVITY, verbose=FALSE)

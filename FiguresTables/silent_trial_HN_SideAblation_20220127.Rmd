---
title: "silent_trial_HN_SideAblation_20220129"
author: "LaurenErdman"
date: "01/29/2022"
output: 
  html_document:
...
raw_in = readLines(paste0(results_wd,"/Ablation/NoFinalLayerFineTuneSickKidsTrained_SideAblated_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json"))
test = v8()
...
side_ablation_list = list()
side_ablation_list[["st_overall"]] = list()
side_ablation_list[["st_overall"]][["aucs"]] = st_overall_origmod_auc
side_ablation_list[["st_overall"]][["sen_spec"]] = st_overall_origmod
...
side_ablation_list[["st_mostrec"]] = list()
side_ablation_list[["st_mostrec"]][["aucs"]] = st_mostrec_origmod_auc
side_ablation_list[["st_mostrec"]][["sen_spec"]] = st_mostrec_origmod
...
side_ablation_list[["stan_all"]] = list()
side_ablation_list[["stan_all"]][["aucs"]] = stan_all_origmod_auc
side_ablation_list[["stan_all"]][["sen_spec"]] = stan_all_origmod
...
side_ablation_list[["ui_all"]] = list()
side_ablation_list[["ui_all"]][["aucs"]] = ui_all_origmod_auc
side_ablation_list[["ui_all"]][["sen_spec"]] = ui_all_origmod
...
side_ablation_list[["chop_all"]] = list()
side_ablation_list[["chop_all"]][["aucs"]] = chop_all_origmod_auc
side_ablation_list[["chop_all"]][["sen_spec"]] = chop_all_origmod

saveRDS(object = side_ablation_list, file = paste0(results_wd,"/sideablation_model_list_results_20220207.rds"))

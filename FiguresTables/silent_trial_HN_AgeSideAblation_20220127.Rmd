---
title: "HN AgeSideAblation 20220129"
author: "LaurenErdman"
date: "29/01/2022"
output: 
  html_document:
...
raw_in = readLines(paste0(results_wd,"/Ablation/NoFinalLayerFineTuneSickKidsTrained_AgeSideAblated_TrainOnly_40epochs_bs16_lr0.001_RCFalse_covTrue_OSFalse.json"))
test = v8()
...
ageside_ablation_list = list()
ageside_ablation_list[["st_overall"]] = list()
ageside_ablation_list[["st_overall"]][["aucs"]] = st_overall_origmod_auc
ageside_ablation_list[["st_overall"]][["sen_spec"]] = st_overall_origmod
...
ageside_ablation_list[["st_mostrec"]] = list()
ageside_ablation_list[["st_mostrec"]][["aucs"]] = st_mostrec_origmod_auc
ageside_ablation_list[["st_mostrec"]][["sen_spec"]] = st_mostrec_origmod
...
ageside_ablation_list[["stan_all"]] = list()
ageside_ablation_list[["stan_all"]][["aucs"]] = stan_all_origmod_auc
ageside_ablation_list[["stan_all"]][["sen_spec"]] = stan_all_origmod
...
ageside_ablation_list[["ui_all"]] = list()
ageside_ablation_list[["ui_all"]][["aucs"]] = ui_all_origmod_auc
ageside_ablation_list[["ui_all"]][["sen_spec"]] = ui_all_origmod
...
ageside_ablation_list[["chop_all"]] = list()
ageside_ablation_list[["chop_all"]][["aucs"]] = chop_all_origmod_auc
ageside_ablation_list[["chop_all"]][["sen_spec"]] = chop_all_origmod

saveRDS(object = ageside_ablation_list, file = paste0(results_wd,"/agesideablation_model_list_results_20220207.rds"))
